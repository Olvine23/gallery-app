    ...
    <div className="max-w-sm rounded overflow-hidden my-10 mx-auto sm:mx-auto ">
      <form onSubmit={onSubmit} className="w-full max-w-sm">
        <div className="flex items-center border-b border-b-2 border-teal-500 py-2 ml-5">
          ...
          <button className="flex-shrink-0 bg-teal-500  mr-8 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-black py-1 px-2 rounded" type="submit">
            Search
          </button>
        </div>
      </form>
